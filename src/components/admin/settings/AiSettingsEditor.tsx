...
const PRESETS: Preset[] = [
  ...
  { id: 'google', type: 'google', baseUrl: 'https://generativelanguage.googleapis.com/v1beta', label: 'Google (Gemini)', models: ['gemini-flash-latest', 'gemini-pro-latest', 'gemini-3.6-flash', 'gemini-2.5-flash'] },
  ...
  { id: 'openrouter', type: 'openai', baseUrl: 'https://openrouter.ai/api/v1', label: 'OpenRouter', models: ['google/gemini-flash-latest', 'deepseek/deepseek-chat', 'anthropic/claude-sonnet-4-6'] },
